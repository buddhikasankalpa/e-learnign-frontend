...
//   if (!url) return null;
//   // Handle both full URLs and bare IDs (e.g. "abc123xyz")
//   const match = url.match(/(?:v=|youtu\.be\/|embed\/)([^&?/\s]{6,})/);
//   if (match) return match[1];
//   // If no URL pattern found but looks like a raw ID (11 chars, no spaces)
...
//       if (editVideo) {
//         const { videoId, ...updateData } = form;
//         await axios.put(BACKEND + "/course-videos/" + editVideo.videoId, updateData, { headers });
//         setMsg({ type: "success", text: "Video updated successfully!" });
//       } else {
//         await axios.post(BACKEND + "/course-videos", form, { headers });
//         setMsg({ type: "success", text: "Video added successfully!" });
//       }
//       setShowForm(false);
//       refreshVideos();
...
//                                 <img
//                                   src={`https://img.youtube.com/vi/${getYouTubeId(v.videoUrl)}/default.jpg`}
//                                   alt=""
...
//                   <div className="mt-2 rounded-xl overflow-hidden aspect-video border border-slate-100">
//                     <iframe
