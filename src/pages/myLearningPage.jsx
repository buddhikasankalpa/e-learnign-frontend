  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      <div className="flex min-h-screen">
        ...
        {/* Sidebar */}
        <aside className="hidden lg:flex h-screen w-72 sticky top-0 flex-col gap-2 p-4 bg-slate-50 border-r border-gray-200">
          ...
          <div className="mt-auto p-2 mb-4">
            <button
              onClick={() => navigate("/")}
              className="w-full bg-blue-600 text-white py-3 rounded-xl font-bold text-sm shadow-lg hover:bg-blue-700 transition"
            >
              Browse More Courses
            </button>
          </div>
        ...
        <main className="flex-1 p-8 md:p-12">
          ...
          {!loaded ? (
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-16 text-center shadow-sm">
              ...
              <button
                onClick={() => navigate("/")}
                className="bg-blue-600 text-white px-6 py-3 rounded-xl text-sm font-bold hover:bg-blue-700 transition shadow-lg"
              >
                Browse Courses
              </button>
            </div>
            ...
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
                {courses.map((course, i) => (
                  <div
                    key={i}
                    className="group bg-white rounded-2xl overflow-hidden shadow-lg hover:-translate-y-1 transition-all duration-200 cursor-pointer border border-gray-100"
                  ...
                  >
                    ...
                    <div className="p-6">
                      ...
                      <button
                        className="w-full py-3 bg-gray-100 text-gray-900 font-bold rounded-xl text-sm group-hover:bg-blue-600 group-hover:text-white transition-all duration-200"
                        onClick={(e) => {
                          e.stopPropagation();
